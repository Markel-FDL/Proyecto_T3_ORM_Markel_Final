...
public class SuministroDeProveedores extends javax.swing.JFrame {
     ...
     */
    public SuministroDeProveedores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sumnistros de proveedores");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuministroDeProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuministroDeProveedores().setVisible(true);
            }
        });
    }
