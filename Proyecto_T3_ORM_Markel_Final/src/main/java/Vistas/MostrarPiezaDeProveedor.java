 ...
 * @author 9fdam05
 */
public class MostrarPiezaDeProveedor extends javax.swing.JFrame {
    Acciones operaciones = new Acciones();
    String[] columna = new String[]{"Cod Proveedor", "Nombre", "Apellidos", "Nº Piezas", "Cant.suministrada", "Nº Proyectos"};

    /**
     * Creates new form Gpp
     */
    public MostrarPiezaDeProveedor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarPiezaDeProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarPiezaDeProveedor().setVisible(true);
            }
        });
    }
