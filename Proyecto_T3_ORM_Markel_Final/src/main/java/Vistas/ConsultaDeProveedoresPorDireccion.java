...
public class ConsultaDeProveedoresPorDireccion extends javax.swing.JFrame {
     ...
     */
    public ConsultaDeProveedoresPorDireccion() {
        initComponents();
    }
    ...
    private void buscarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarBotonActionPerformed
        if (!textoBusqueda.getText().trim().equals("")) {
            ArrayList<ProveedoresEntity> proveedores = acciones.mostrarProveedorPorFiltro("direccion", textoBusqueda.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDeProveedoresPorDireccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDeProveedoresPorDireccion().setVisible(true);
            }
        });
    }
