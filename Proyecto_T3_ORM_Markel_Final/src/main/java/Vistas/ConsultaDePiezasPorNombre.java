...
public class ConsultaDePiezasPorNombre extends javax.swing.JFrame {
     ...
     */
    public ConsultaDePiezasPorNombre() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDePiezasPorNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDePiezasPorNombre().setVisible(true);
            }
        });
    }
