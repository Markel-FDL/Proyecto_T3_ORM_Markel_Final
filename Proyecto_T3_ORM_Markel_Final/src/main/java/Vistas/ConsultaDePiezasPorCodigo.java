...
public class ConsultaDePiezasPorCodigo extends javax.swing.JFrame {
     ...
     */
    public ConsultaDePiezasPorCodigo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDePiezasPorCodigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDePiezasPorCodigo().setVisible(true);
            }
        });
    }
