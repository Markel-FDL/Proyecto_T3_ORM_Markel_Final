...
public class ConsultaDeProveedoresPorNombre extends javax.swing.JFrame {
     ...
     */
    public ConsultaDeProveedoresPorNombre() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDeProveedoresPorNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDeProveedoresPorNombre().setVisible(true);
            }
        });
    }
