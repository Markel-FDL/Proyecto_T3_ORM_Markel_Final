...
public class ConsultaDeProyectosPorCiudad extends javax.swing.JFrame {
     ...
     */
    public ConsultaDeProyectosPorCiudad() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDeProyectosPorCiudad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDeProyectosPorCiudad().setVisible(true);
            }
        });
    }
