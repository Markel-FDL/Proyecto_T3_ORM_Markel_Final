...
public class MostrarListadoDeGestion extends javax.swing.JFrame {
     ...
     */
    public MostrarListadoDeGestion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarListadoDeGestion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarListadoDeGestion().setVisible(true);
            }
        });
    }
